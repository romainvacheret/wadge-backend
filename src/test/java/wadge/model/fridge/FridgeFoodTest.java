...
//         food = new FridgeFood(id, "Food", new FoodElement[] {new FoodElement(elementId, "date 1", "date 2", 42)});
//     }
...
//         FridgeFood f1 = new FridgeFood("Food", List.of(new FoodElement(UUID.randomUUID(), "date 1", "date 2", 42)));
//         FridgeFood f2 = new FridgeFood("Name", List.of(new FoodElement(UUID.randomUUID(), "d1", "d2", 42)));
